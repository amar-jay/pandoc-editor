...
export function EditorPane({
  ...
  // Get cursor styles based on settings and vim mode
  const getCursorStyles = () => {
    ...
    switch (settings.cursorStyle) {
      case 'thick':
        styles.caretColor = 'currentColor'
        styles.borderLeft = '3px solid transparent'
        break
      case 'block':
        ...
        <div className="flex h-full">
            ...
            >
              <div className="p-4 pr-2 text-right text-muted-foreground font-mono select-none">
                {Array.from({ length: lineCount }, (_, i) => (
                  <div key={i + 1} style={{ height: `${fontSize * settings.lineHeight}px` }}>
                    {i + 1}
                  </div>
                ))}
              </div>
          ...
          <div className="flex-1 relative">
            <textarea
              ...
              className="editor-textarea w-full h-full p-4 resize-none border-0 outline-none bg-transparent font-mono leading-relaxed"
